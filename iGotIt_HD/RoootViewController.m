...
- (void)viewDidLoad
{
    ...
    self.detailTableViewController = [self.splitViewController.viewControllers lastObject];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.detailTableViewController.detailItem = selectedObject;    
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    */
    ...
    // Set the filter predicate to only display favorites
...
- (void)insertNewObject
{
    ...
    NSManagedObjectContext *context = [self.fetchedResultsController managedObjectContext];
    [ActionClass createParent:@"New Item" managedObjectContext:context];
